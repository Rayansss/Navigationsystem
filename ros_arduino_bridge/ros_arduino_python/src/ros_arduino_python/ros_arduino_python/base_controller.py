...
class BaseController:
     def __init__(self, arduino, base_frame):
         ...
         pid_params['right_Kp'] = rospy.get_param("~right_Kp", "")
         pid_params['right_Kd'] = rospy.get_param("~right_Kd", "")
         pid_params['right_Ki'] = rospy.get_param("~right_Ki", "")
         pid_params['right_Ko'] = rospy.get_param("~right_Ko", "")
         ...
         self.odomPub = rospy.Publisher('odom', Odometry, queue_size=30)
         ...
         if self.debugPID:
                 self.lEncoderPub = rospy.Publisher('Lencoder', Int32, queue_size=30)
                 self.rEncoderPub = rospy.Publisher('Rencoder', Int32, queue_size=30)
                 self.lPidoutPub = rospy.Publisher('Lpidout', Int32, queue_size=30)
                 self.rPidoutPub = rospy.Publisher('Rpidout', Int32, queue_size=30)
                 self.lVelPub = rospy.Publisher('Lvel', Int32, queue_size=30)
                 self.rVelPub = rospy.Publisher('Rvel', Int32, queue_size=30)
